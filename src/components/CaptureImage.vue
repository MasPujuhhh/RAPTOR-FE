...
let stream = null;
const token =
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..gV_Z6LWFVYQD2uqNGc2czzvY-4vPveT1AtXJgrMxJMY";
...
const saveImage = async () => {
  ...
  try {
    const res = await axios.post(
      `http://localhost:9001/absensi/add`,
      formData,
      {
        headers: {
