    ...
    <main>
      ...
      >
        ...
        <div class="list-group">
          <a v-for="item in pengumumans" href="#" @click="readpengumuman(item)" class="list-group-item list-group-item-action" :style="item.is_read ? `background-color:rgba(189, 195, 199, 0.2)` : `background-color:white`"  aria-current="true">
