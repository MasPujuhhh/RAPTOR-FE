        ...
        >
          ...
          >
            <div
              ...
              class="table-header"
            >
              <h4 style="font-weight: bold">Tugas</h4>
              <button
                type="button"
                class="btn btn-success"
                style="font-weight: bold"
                @click="$router.push('/admin/task/add')"
              >
                        ...
                        <div class="modal-body" style="display: flex; gap: 1.8rem; padding: 1rem; justify-content: center;">
                            <div style="width: 57%; height: auto; " >
                                ...
                                <h6 style="margin-bottom: 2rem;">
                                    ...
                                    <!-- <button v-if="detail_todos[0]?.todo_done" type="button" class="btn btn-success">{{ todos[0]?.info }}</button> -->
